...
-- Offre fondateurs + essai gratuit de 14 jours
...
-- ------------------------------------------------------------
-- 7) Déclencheur : essai gratuit 14 jours + offre fondateurs
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- PENDANT l'offre fondateurs (fenêtre de 14 jours), une demande de paiement
...
-- gérants, ventes/dépenses, stock, fournisseurs, caisse, essai 14 jours,
