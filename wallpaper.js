...
<svg xmlns="http://www.w3.org/2000/svg" width="260" height="260" viewBox="0 0 260 260">
  <g fill="#E8B65A" fill-opacity="0.055">
    ...
    <g transform="translate(150,10) rotate(6)">
      ...
      <rect x="5" y="5" width="20" height="8" rx="1.5" fill="none"/>
    ...
    <g transform="translate(190,90) rotate(10)">
      ...
      <rect x="5" y="7" width="16" height="2.4" fill="none"/>
      <rect x="5" y="14" width="16" height="2.4" fill="none"/>
      <rect x="5" y="21" width="10" height="2.4" fill="none"/>
    </g>

    <!-- portefeuille -->
    <g transform="translate(15,140) rotate(-6)">
      <rect x="0" y="6" width="34" height="24" rx="4"/>
      <path d="M0 12h34v6a6 6 0 0 1-6 6H6a6 6 0 0 1-6-6z" fill="#0B1120" fill-opacity="0.35"/>
    ...
    <g transform="translate(185,180) rotate(-10)">
      ...
      <path d="M10 8V5a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v3" fill="none" stroke="#E8B65A" stroke-opacity="0.055" stroke-width="3"/>
      <rect x="0" y="16" width="32" height="4" fill="#0B1120" fill-opacity="0.35"/>
    </g>
    ...
    <g transform="translate(230,230) rotate(-15)">
      <circle cx="12" cy="12" r="12"/>
      <path d="M12 12 L12 0 A12 12 0 0 1 22 18 Z" fill="#0B1120" fill-opacity="0.4"/>
    </g>
...
// Le fond reste transparent : la couleur vient de `.cc-app` (ui.css), ce qui
// permet au filigrane de se superposer au dégradé de la page sans le masquer.
